...
const tmpl: string = `/*
  ...
  Content-Security-Policy: default-src 'none'; script-src 'self'; img-src 'self' data: https://explorer-api.walletconnect.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; manifest-src 'self'; connect-src 'self' wss://*.walletconnect.com https://*.walletconnect.com wss://*.walletconnect.org https://*.walletconnect.org https://*.web3modal.org wss://*.web3modal.org https://api.rescuenode.com https://cloudflare-eth.com; frame-ancestors 'self'; base-uri 'none'; form-action 'self'; upgrade-insecure-requests; report-uri https://rescuenode.com/csp-report; frame-src https://verify.walletconnect.com https://verify.walletconnect.org;
